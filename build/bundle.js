...
/***/ function(module, exports, __webpack_require__) {
	...
	var RuleExample = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('div', { className: this.props.className, onClick: this._ruleToggle }, React.createElement('b', null, this.props.title), ':', this.props.caption, React.createElement('br', null), this.props.cardArray);
	  }
	});
